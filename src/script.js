...
const doorBlood = textureLoader.load('/textures/door/2808.jpg')
 ...
 * Ghosts
 */
const ghost1 = new THREE.PointLight('#BDBDC5', 3, 3)
...
const ghost3 = new THREE.PointLight('#ff7899', 3, 3)
...
loader.load( '/textures/tree_scan_free.glb', function ( gltf ) {

	scene.add( gltf.scene );
    gltf.scene.position.set(4,2.4,-1)
